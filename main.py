...
def fit_func(bits, mapa_original, mascara, R):
    ...
    erro = faltando  # Penaliza por número de círculos usados
    
    percentual = total_coberto/total_para_cobrir*100
...
def main():
    ...
    rota, distancia = genetic_tsp(centros, 25000)

    circulos = len(centros)
    ...
    f.visualizar_mapa(mapa_coberto, centros, raio, rota, distancia, percentual, circulos)
