...
def genetic_tsp(coordinates, generations, population_size=100, crossover_rate=0.9, mutation_rate=0.35, elitism=False):
    ...
    closed_route = np.append(best_route, best_route[0])
    return closed_route, best_distance
